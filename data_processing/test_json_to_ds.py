...
def _compile_filepath_list(input):
        import glob, os
        filepaths = []
        for root, dirs, files in os.walk('./cnn/data/'):
            for file in files:
...
def main():
    ...
    filenames = ['/home/ubuntu/data_processing/cnn/data/dataminesjc_7days_app_saeed_data.json']
