...
class NameLookup:
    ...
    def __init__(self):
        ...
        with open('inception/imagenet_synset_to_human_label_map.txt', mode='r') as file:
        ...
        with open('inception/imagenet_2012_challenge_label_map_proto.pbtxt', mode='r') as file:
            # Read all lines from the file.
            lines = file.readlines()
